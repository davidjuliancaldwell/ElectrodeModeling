...
prompt = {'how many channels did we record from? e.g 48 ', 'what were the stimulation channels? e.g 28 29 ',...,
    'how long before each stimulation do you want to look? in ms e.g. 1', 'how long after each stimulation do you want to look? in ms e.g 5',...,
    'which trial?'};
dlg_title = 'StimChans';
num_lines = 1;
defaultans = {'98','28 29','1','5','1'};
answer = inputdlg(prompt,dlg_title,num_lines,defaultans);
numChans = str2num(answer{1});
chans = str2num(answer{2});
preTime = str2num(answer{3});
postTime = str2num(answer{4});
trial = str2num(answer{5});
...
if strcmp(plotIt,'y')
    stimTimesBegin = bursts(2,:)-2+delay;
    stimTimesEnd = bursts(3,:)-2+delay+120;
