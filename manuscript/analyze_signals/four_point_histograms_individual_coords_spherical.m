...
for index = 1:numIndices
    ...
    fprintf(['Subject ' num2str(index) ' spherical, mean = ' num2str(round(rhoHist.mean,2)), ' std = ' num2str(round(rhoHist.std,2)) ' median = ' num2str(round(rhoHist.median,2)), ' MAD = ' num2str(round(rhoHist.mad,2)) '\n'])
